    ...
    <div className="flex justify-around items-center h-screen relative max-sm:flex-col max-md:flex-col">
      ...
      <div>
        <img
          src={personImg}
          alt="logo"
          className="h-60 w-96 max-sm:h-20 max-sm:mt-5 max-sm:w-36 max-md:h-28 max-md:w-40"
        />
      </div>
      ...
      <div className="h-auto w-96 rounded shadow-lg bg-white text-center">
        ...
        <div className="flex flex-col items-center mt-10">
          <p className="flex items-center justify-between bg-[#f9f9f9] mb-3 p-2 text-sm w-80">
            Introvert
            <AiFillCheckCircle className="text-xl" />
          </p>
          <p className=" bg-[#f9f9f9] mb-3 p-2 text-sm w-80 text-left">
            Extrovert
          </p>
          <p className=" bg-[#f9f9f9] mb-3 p-2 text-sm w-80 text-left">
            Does not matter
