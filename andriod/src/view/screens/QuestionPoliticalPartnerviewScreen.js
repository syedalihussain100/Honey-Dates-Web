...
const QuestionPoliticalPartnerviewScreen = ({ navigation }) => {
        ...
        <View style={styles.footer}>
          ...
          <TouchableOpacity>
              <View style={styles.NumberInput}>
                <Text style={{ color: COLORS.black }}>Any</Text>
              </View>
            </TouchableOpacity>
            ...
            <View style={{
              ...
              <View style={{
                ...
                <View style={{ marginHorizontal: 5 }}>
                  <CustomeButton onpress={() => navigation.navigate('QuestionIntroandExtroScreen')}
                    title={'Continue'} />
                </View>
              </View>
