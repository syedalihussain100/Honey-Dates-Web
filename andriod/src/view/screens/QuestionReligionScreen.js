...
const QuestionReligionScreen = ({ navigation }) => {
      ...
      <View>
        {RelagionType.map((TypeTestimonial, index) => (
          <TouchableOpacity
            key={index}
            activeOpacity={0.8}
            onPress={() => navigation.navigate(TypeTestimonial.onpress)}
      ...
      <StatusBar backgroundColor={COLORS.black} />
        <View style={styles.container}>
          ...
          <View style={{
            ...
            <CustomeButton onpress={() => MoreAboutReligion()}
              title={'Continue'} />
